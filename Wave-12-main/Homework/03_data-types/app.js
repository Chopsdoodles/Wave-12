...
//c)
console.log( item1Name,price1,item2Name,price2,item3Name,price3);
...
// Because you can not calculate the string, so use parseFloat to a floating point number.
...
console.log(`After Discount (10%) : $${discountedSubtotal.toFixed(2)}`);
//b)
...
//c)
const isValidCode = discountCode.trim().toUpperCase() === "SAVE10";
console.log(`Discount code valid:${isValidCode}`) //true.
...
// your code here
//a)
console.log(`typeof line1Total: ${typeof line1Total}`); // number
console.log(`typeof grandTotal: ${typeof grandTotal}`); // number
// b)
console.log(`orderStatus: ${orderStatus}`);
console.log(`typeof orderStatus: ${typeof orderStatus}`);
console.log(`Boolean(orderStatus): ${Boolean(orderStatus)}`);
// null means that it has been set to no value because it has yet to be processed.
//c)
console.log(`item1price + item2Price = ${item1Price + item2Price}`);
// Because the + operator makes it concatenation ,and item1Price and Item2Price are strings not numbers.
...
//Q1: + operator taught me that i can write a shortcut for example  token = token + 2" as "token += 2"
//Q2: using .trim(), .toLowerCase(), .toUpperCase(), .includes(), .length, .slice()
//Q3: If/else checks if runs if the condition is true, else runs if the condition is false.
// ----------------------------------------------------------
