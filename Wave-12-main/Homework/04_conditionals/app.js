...
const studentName = "Miguel"; // Student name wont change .
const maxScore = 100; // Max score would also stay the same .
const passingScore = 60; // Passing score would be the benchmark and would not change.
const earnedScore = 73; // This would stay the same also since the earned score would not change in the real world scenario.
const isExtraCredit = false; // this would also be a const since we can use the if/else to give us the correct output.
...
if (isExtraCredit) { earnedScore += extraCreditPoints;
...
// Because the code is executed in order from top to bottom.
// ----------------------------------------------------------
...
if (earnedScore >= passingScore) {
    ...
    else { console.log(studentName + " — FAILED ❌")
};
// ----------------------------------------------------------
